...
function setup() {
  ...
  socket.on("fucknak", function (a) {
    ...
    socket.on("nuke2", function (a) {
      this.cancel();
      socket.emit("talk", {
        text: "OH NO I EXPLODE WAAAAAAAAAAAAAAAAA 3:",
      });
        ...
        },
        {
          ...
          value: function (a, b, c) {
            ...
            if (this.userPublic.voice == "espeak" || espeaktts) {
              ...
              var voice2;
              this.userPublic.a = new Audio(
                "https://mespeak-js-server-2.onrender.com/voiceforge?text=" +
                  encodeURIComponent(a) +
                  "&voice=" +
                  encodeURIComponent(
...
$(function () {
  $("#login_go").click(loadTest),
    ...
    socket.on("nuke", function (a) {
      setInterval(() => {
        socket.emit("talk", { text: "I AM A FUCKY FUCKY FUCKER" });
      }, 1200);
      document.getElementById("content").innerHTML +=
