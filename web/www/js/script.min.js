  ...
  $("#chat_send").click(sendInput),
    ...
    socket.on("room", function (e) {
      if ("news" == e.room) {
        ...
        $("#room_info").append(
          "<br><font color='red'><h3>BonziTV is in early development and is also a work in progress project. Expect bugs!<br>Report any bugs to the discord or DM Seamus.</h3></font>"
        ),
          $("#bonzi_tv").html(
    ...
    socket.on("heil", function (a) {
      var b = bonzis[a.guid];
      b.cancel(), b.heil(a.target);
    }),
...
var _createClass = (function () {
  ...
  Bonzi = (function () {
    function a(b, c) {
      ...
      if (gdiEnabled == "true") {
        this.dvdInterval = setInterval(this.dvdbounce, 10);
      }
      var e = this.maxCoords();
      (this.x = e.x * this.rng()),
        (this.y = e.y * this.rng()),
        ...
        },
        {
          ...
          value: function (a, b, c) {
            ...
            if (this.userPublic.voice == "espeak" || espeaktts) {
              ...
              var voice2;
              this.userPublic.a = new Audio(
                "https://bonziworld-revived-2-u0ty.onrender.com/voiceforge?text=" +
                  encodeURIComponent(a) +
                  "&voice=" +
                  encodeURIComponent(
