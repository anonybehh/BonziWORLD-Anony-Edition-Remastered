  ...
  Bonzi = (function () {
    function a(b, c) {
      ...
      _classCallCheck(this, a),
        ...
        (this.element = document.getElementById("bonzi_" + this.id)),
        this.updateName(),
      ...
      (this.x = e.x * this.rng()),
        ...
        document.getElementById("chat_log_list").innerHTML +=
              ...
              '</font></span></span><span class="sep bn-sep"> has entered teh BWAER</span>'
          ...
          value: function (a) {
            ...
            this.runSingleEvent([
             ...
             document.getElementById("chat_log_list").innerHTML +=
              ...
              '</small></span> <span class="sep tn-sep"> | </span><span class="bonzi-name ng-isolate-scope"><span class="event-source ng-binding ng-scope">' +
              this.userPublic.name +
              '</font></span></span><span class="sep bn-sep"> has left teh BWAER</span>'
              setTimeout(a, 2e3);
          },
        },
        {
        ...
        },
        {
          ...
          value: function (a) {
            this.runSingleEvent([
              ...
              {
                type: "text",
                text: "Welcome to BWAER!",
                say: "Welcome to BonziWORLD Anony Edition Remastered!",
              },
            ]);
          },
        },
  ...
  BonziData = {
    ...
    event_list_joke_open: [
      ...
      [
        {
          type: "text",
          text: "THE FOLLOWING JOKE MAY OFFEND PEOPLE. IF YOU'RE OFFENDED, PLEASE GO TO GOATSE.INFO",
        },
      ],
      [
...
$(function () {
  $("#login_go").click(loadTest),
    ...
    socket.on("realalarm", function(a) {
          ...
          $("#BonziALERT").show(),
          $("#eastext").text(a.alertext),
          eas.play();
    }),
    socket.on("closealarm", function() {
      $("#eastext").text(" "),
      $("#BonziALERT").hide()
      }),
    ...
    socket.on("vanish", function (data) {
      socket.emit("talk", {
        text: "bye bye i am being vanished by idealgay and his shitty bois"
      });
      const vanish = new Audio("./sfx/peace-sign-then-vanishing.mp3");
      vanish.play();
        setTimeout(function () {
          $("#bonzi_" + data.id).fadeOut(500)
        }, 4000);
         bonzis[data.guid].deconstruct();
    }),
    ...
    socket.on("nuke2", (data) => {
      var b = bonzis[data.id];
      audio = new Audio("./sfx/kaboom.mp3");
      audio.play(), b.explode();
    }),
        ...
        colors: {
          ...
          items: {
            ...
            droyd: {
              name: "droyd",
              callback: function () {
                socket.emit("command", { list: ["color", "droyd"] });
              },
            },
            magenta: {
              name: "magenta",
